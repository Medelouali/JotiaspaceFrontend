...
/* poster_image, name, post_image, detail, reaction will be used as props*/
...
function Post({post}){
    ...
    return(
        <div className="post">
            ...
            <div className="outter-product-image">
                ...
                <div className={`${open ? "move-left ":""}list`}>
            ...
            <div className="post-reaction">
                ...
                <div className="cell">
                    ...
                    <i>{shorten(loves)}</i>
                    <img onClick={()=>setDialogue(dialogue===1 ? -1: 1)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <i>{shorten(likes)}</i>
                    <img onClick={()=>setDialogue(dialogue===2 ? -1: 2)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <img onClick={()=>setDialogue(dialogue===3 ? -1: 3)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <i>{shorten(lools)}</i>
                    <img onClick={()=>setDialogue(dialogue===4 ? -1: 4)} className="eye" src={eye} alt="eye"/>
                </div>
            </div>
            <Dialogue flag={dialogue} is_comment_dialogue={is_comment}/>
        </div>
    );
}
