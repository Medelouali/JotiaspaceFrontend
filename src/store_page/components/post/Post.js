        ...
        <div className="post">
            ...
            <div className="cells">
                ...
                <div className="cell">
                    ...
                    <i>{shorten(loves)}</i>
                    <img onClick={setDial(1)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <i>{shorten(likes)}</i>
                    <img onClick={setDial(2)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <img onClick={setDial(3)} className="eye" src={eye} alt="eye"/>
                </div>
                ...
                <div className="cell">
                    ...
                    <i>{shorten(lools)}</i>
                    <img onClick={setDial(4)} className="eye" src={eye} alt="eye"/>
                </div>
            </div>
            <div className="dialo" ref={divRef}><Dialogue flag={dialogue} is_comment_dialogue={is_comment}/></div>
        </div>
    );
}
